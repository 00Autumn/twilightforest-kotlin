...
public class TFHangingSignBlock extends HangingSignBlock implements TFHangingSign {
    private final Identifier texture;
    private final Identifier guiTexture;

    public TFHangingSignBlock(Identifier texture, Identifier guiTexture, WoodType woodType, Settings settings) {
        super(woodType, BlockSettingsLock.lock(settings));
        this.texture = texture;
        this.guiTexture = guiTexture;
    }

    public TFHangingSignBlock(Identifier texture, Identifier guiTexture, Settings settings) {
